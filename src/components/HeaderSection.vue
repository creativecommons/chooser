<template>
  <header>
    <div class="masthead">
      <h1>
        <a class="identity-logo" href="https://creativecommons.org"
          >Creative Commons</a
        >
      </h1>
      ...
      <nav class="ancilliary-menu">
        <ul>
          <li>
            <a
              class="search icon-attach fa-search"
              href="https://creativecommons.org/?s"
              >Search</a
            >
          </li>
          <li>
