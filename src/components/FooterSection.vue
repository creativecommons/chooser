  ...
  <footer>
    ...
    <div class="license">
      <p>
        ...
        <a href="https://creativecommons.org/policies/#license">noted</a>,
      ...
      <svg>
        <use
          href="../../static/vocabulary/svg/cc/icons/cc-icons.svg#cc-logo"
        ></use>
      </svg>
      <svg>
        <use
          href="../../static/vocabulary/svg/cc/icons/cc-icons.svg#cc-by"
        ></use>
      </svg>
    </div>
  </footer>
