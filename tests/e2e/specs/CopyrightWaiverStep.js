  ...
  'Check if user can check and uncheck checkboxes'(browser) {
    browser.assert
      .attributeEquals(
        ...
        'disabled',
        'true',
        'Next Button disabled when checkboxes not checked'
      )
      ...
      .assert.attributeEquals(
        ...
        'disabled',
        null,
        'Next Button enabled when user checks agreed and confirmed'
      )
      .click('.v-checkbox:nth-child(1) input[type="checkbox"]')
      .assert.attributeEquals(
        '.next-button',
        'disabled',
        'true',
        'Next button disabled when user unchecks agreed'
      )
      ...
      .assert.attributeEquals(
        ...
        'disabled',
        null,
        'Next Button enabled when user re-checks agreed'
      )
      .click('.v-checkbox:nth-child(2) input[type="checkbox"]')
      .assert.attributeEquals(
        '.next-button',
        'disabled',
        'true',
        'Next button disabled when user unchecks confirmed'
      )
  },
}
