module.exports = {
  'Check if the main div tag with the class selected-license-card is present'(
    browser
  ) {
    browser
      .init()
  ...
  'Check if the license deed link redirects correctly'(browser) {
    browser.assert
      .elementPresent('a[class="license-deed-link"]')
