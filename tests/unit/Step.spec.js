...
describe("Step.vue", () => {
    ...
    it("Checks if the showDisabledDue function returns the correct boolean when enabled \
        is true and disabledDue is equal to undefined", () => {
        wrapper.setProps({
            enabled: true,
    ...
    it("Checks if the showDisabledDue function returns the correct boolean when enabled \
        is false and disabledDue is equal to undefined", () => {
        wrapper.setProps({
            enabled: false,
            disabledDue: undefined
        });
